...
flowchart TD
    ...
    style MD fill:#331a00,stroke:#FF4E00,color:#fff
    style URL fill:#1a0e06,stroke:#FF4E00,color:#fff
    style LLMS fill:#1a0e06,stroke:#FF4E00,color:#fff
    style BUILD fill:#2d1a0a,stroke:#FF4E00,color:#fff
```
